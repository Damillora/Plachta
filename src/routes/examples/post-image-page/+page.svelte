	...
	<Post>
		...
		<PostMain>
			...
			<p>
				...
				we've come to cash this check, a check that will give us upon demand the riches of freedom
			...
			<p>
				...
				rude awakening if the nation returns to business as usual. And there will be neither rest
				nor tranquility in America until the Negro is granted his citizenship rights. The whirlwinds
				of revolt will continue to shake the foundations of our nation until the bright day of
				justice emerges.
			</p>
			<p>
			...
			<p>
				...
				here today, have come to realize that their destiny is tied up with our destiny. And they
			...
			<p>
				...
				has nothing for which to vote. No, no, we are not satisfied, and we will not be satisfied
